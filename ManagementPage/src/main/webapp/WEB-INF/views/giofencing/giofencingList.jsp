...
<div class="list">
	...
	<%-- 
		<form name="form1" id="form1" method="post" action="PageController">
			...
			<div class="list_tit">실외출입 확진자</div>
			...
			<thead>
				<tr>
					...
					<select id="select">
						...
						<option value="b.mb_name">이름 검색</option>
						<option value="a.time">출입시간</option>
					</select> <input type="text" id="searchMeetName"
						name="searchMeetName" align="left"> <!-- keyup 이벤트 사용에 따른 엔터키 방지용 보이지 않는 input text -->
						<input type="text" style="display: none"> <input
						type="button" id="GiofencingList" align=right value="조회">
					</td>
				</tr>
				<tr>
					<th>이름</th>
